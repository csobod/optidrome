...
class PrescriptionForm(npyscreen.FormBaseNew):
    "Prescription record on screen for maintenance."
    ...
    def create(self):
        ...
        self.formTitle = pname + " " + version + " - Prescription record "
...
# 3,2. 
        self.prescriptionCols=self.add(bs.MyFixedText, name="PrescriptionCols", value="SPH          CYL          AXIS          PRISM          ADD", relx=20, rely=10, use_max_space=True, editable=False)
        self.prescriptionRows=self.add(bs.MyFixedText, name="PrescriptionRows", value="OD")
        # Form fields
